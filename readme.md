...
Backend: PHP e o framework Symfony, responsáveis pela lógica de negócio e API.

Frontend: Angular e TypeScript para a criação de uma interface de usuário dinâmica.
